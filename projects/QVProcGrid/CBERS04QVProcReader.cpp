...
//
//	string tilFile = strPath + "\\IMAGE.TI";
...
bool CBERS04QVProcReader::read_by_scene(const char* filename, const char* outPath)
{
	...
	//writeDescXML(theHeaderInfo, (strPath+"\\META.XM").c_str());
	...
	writeDescXML(theHeaderInfo, gpsList, attList, outPath);
	return true;
}
...
void CBERS04QVProcReader::BitInverse(char* chrs, int nBit)
{
...
int CBERS04QVProcReader::timeCompare(const _TIMESTAMP& t1, const _TIMESTAMP& t2)const
{
	int diff = 0;
...
string CBERS04QVProcReader::time2String(const _TIMESTAMP& t)const
{
...
//
//	// Ephemeris
//	xmlWriter->writeStartElement("Ephemeris");
//	for (aux = auxList.begin();
//		aux != auxList.end();
//		aux++)
//	{
//		xmlWriter->writeStartElement("Point");
//		//<TIME>2004-06-02T03:04:40.000000</TIME>
//		//	<Location>
//		//	<X>-2.6771366000e+08</X>
//		//	<Y>4.8356931700e+08</Y>
//		//	<Z>4.6133688400e+08</Z>
//		//	</Location>
//		//	<Velocity>
//		//	<X>-6.2813600000e+05</X>
//		//	<Y>5.0038500000e+06</Y>
//		//	<Z>-5.5944260000e+06</Z>
//		//	</Velocity>
//
//		xmlWriter->writeStartElement("TIME");
//		xmlWriter->writeCharacters(QString::number(aux->gps_time, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("Location");
//		xmlWriter->writeStartElement("X");
//		xmlWriter->writeCharacters(QString::number(aux->satpos.x, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("Y");
//		xmlWriter->writeCharacters(QString::number(aux->satpos.y, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("Z");
//		xmlWriter->writeCharacters(QString::number(aux->satpos.z, 'f', 10));
//		xmlWriter->writeEndElement();
//		xmlWriter->writeEndElement();
//		// end of Location
//
...
//		xmlWriter->writeStartElement("X");
//		xmlWriter->writeCharacters(QString::number(aux->satpos.vx, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("Y");
//		xmlWriter->writeCharacters(QString::number(aux->satpos.vy, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("Z");
//		xmlWriter->writeCharacters(QString::number(aux->satpos.vz, 'f', 10));
//		xmlWriter->writeEndElement();
//		xmlWriter->writeEndElement();
//		// end of Velocity
//
...
//
//	// Attitudes
//	xmlWriter->writeStartElement("Attitudes");
//	for (aux = auxList.begin();
//		aux != auxList.end();
//		aux++)
//	{
//		xmlWriter->writeStartElement("Attitude");
//		//<TIME>2004-06-02T03:03:47.054624</TIME>
//		//	<YAW>3.1999999225e-06</YAW>
//		//	<PITCH>3.1999999225e-06</PITCH>
//		//	<ROLL>3.1999999225e-06</ROLL>
//
//		xmlWriter->writeStartElement("TIME");
//		xmlWriter->writeCharacters(QString::number(aux->att_time, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("Angle");
//		xmlWriter->writeStartElement("YAW");
//		xmlWriter->writeCharacters(QString::number(aux->satatt.yaw, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("PITCH");
//		xmlWriter->writeCharacters(QString::number(aux->satatt.pitch, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("ROL");
//		xmlWriter->writeCharacters(QString::number(aux->satatt.roll, 'f', 10));
//		xmlWriter->writeEndElement();
//		xmlWriter->writeEndElement();
//		// end of Angle
//
//		xmlWriter->writeStartElement("Angle_Velocity");
//		xmlWriter->writeStartElement("YAW");
//		xmlWriter->writeCharacters(QString::number(aux->satatt.vyaw, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("PITCH");
//		xmlWriter->writeCharacters(QString::number(aux->satatt.vpitch, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("ROL");
//		xmlWriter->writeCharacters(QString::number(aux->satatt.vroll, 'f', 10));
//		xmlWriter->writeEndElement();
//		xmlWriter->writeEndElement();
//		// end of Angle_Velocity
//
//		xmlWriter->writeEndElement();
//		// end of Attitude
//	}
...
//	// end of Attitudes
//
//	xmlWriter->writeStartElement("Line_Times");
//	for (aux = auxList.begin();
//		aux != auxList.end();
//		aux++)
//	{
//		xmlWriter->writeStartElement("Line_Time");
//
//		xmlWriter->writeStartElement("TIME");
//		xmlWriter->writeCharacters(QString::number(aux->star_time, 'f', 10));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeStartElement("LINE");
//		xmlWriter->writeCharacters(QString::number(aux->line_num-line_offset, 'f', 1));
//		xmlWriter->writeEndElement();
//
//		xmlWriter->writeEndElement();
//		// end of Line_Time
