...
bool addHj1Scene(ossimFilename workfold, vector<Hj1Optimize::HJ1OptStruct>& hj1OptStructList, ossimFilename gcpfilename)
{
	MyProject prj;
	ossimFilename sourceFile = workfold + "\\IMAGE.tif";
	...
	ossimplugins::ossimHj1Model* sensorModel = new ossimplugins::ossimHj1Model();
	sensorModel->setupOptimizer(descfile);
	mylib::readGcpFile(gcpFile, gptSet, chkSet, NULL);

	Hj1Optimize::HJ1OptStruct hj1Struct((ossimHj1Model*)sensorModel, gptSet);
	hj1OptStructList.push_back(hj1Struct);
...
void calcAttitude()
{
	...
	for (size_t i = 0; i < nl; i++)
	{
		...
		addHj1Scene("E:\\HJ1\\Scene08", hj1OptStructList, buf);
	}
	...
	//innerList.push_back(ossimHj1Model::AdjustParamIndex::AY4_OFFSET);
	//innerList.push_back(ossimHj1Model::AdjustParamIndex::AY5_OFFSET);
	//innerList.push_back(ossimHj1Model::AdjustParamIndex::X_OFFSET);
	//innerList.push_back(ossimHj1Model::AdjustParamIndex::Y_OFFSET);
	//innerList.push_back(ossimHj1Model::AdjustParamIndex::Z_OFFSET);
	innerList.push_back(ossimHj1Model::AdjustParamIndex::CCD_CENTER_X_OFFSET);
	innerList.push_back(ossimHj1Model::AdjustParamIndex::CCD_CENTER_Y_OFFSET);

	vector<int> exteriorList;
	exteriorList.push_back(Hj1Optimize::exteriorOptimize::ROLL_OFFSET);
	exteriorList.push_back(Hj1Optimize::exteriorOptimize::PITCH_OFFSET);
	exteriorList.push_back(Hj1Optimize::exteriorOptimize::YAW_OFFSET);
	...
	//	hj1OptStructList[image_index].hj1Model->setAdjustableParameter(ossimHj1Model::AdjustParamIndex::FOCAL_OFFSET, 30.7768);
		...
		//hj1OptStructList[image_index].hj1Model->setAdjustableParameter(ossimHj1Model::AdjustParamIndex::AY4_OFFSET, -4.00537);
		//hj1OptStructList[image_index].hj1Model->setAdjustableParameter(ossimHj1Model::AdjustParamIndex::AY5_OFFSET, 15.2944);
		hj1OptStructList[image_index].hj1Model->setAdjustableParameter(ossimHj1Model::AdjustParamIndex::CCD_CENTER_X_OFFSET, -4);
		hj1OptStructList[image_index].hj1Model->setAdjustableParameter(ossimHj1Model::AdjustParamIndex::CCD_CENTER_Y_OFFSET, 39);
	...
	//Hj1Optimize::blockadjustment::sparselm_adjustment(hj1OptStructList, innerList, exteriorList);
	...
	//	for (tit = theTPV.begin(); tit != theTPV.end(); ++tit)
	//	{
	//		//ossimDpt dpt = hj1OptStructList[image_index].hj1Model->forward(*(*tit));
	//		//imagepoint = (*tit)->getImagePoint();
	...
	//		//compute residue
	//		ossimGpt gd = hj1OptStructList[image_index].hj1Model->inverse((*tit)->tie);
	//		ossimGpt res;
	...
	//	double line = i * step;
	//	double t_line;
	//	hj1OptStructList[i].hj1Model->theSupportData->getLineTime(line, t_line);
	//	ossimDpt3d att(0.0, 0.0, 0.0);
	//	hj1OptStructList[i].hj1Model->theSupportData->getAttitude(t_line, att);
	//	att.x += hj1OptStructList[i].hj1Model->thePitchOffset;
	//	att.y += hj1OptStructList[i].hj1Model->theRollOffset;
	//	att.z += hj1OptStructList[i].hj1Model->theYawOffset;
	...
	while (optimizer_delta > minDelta && iter < iter_max)
	{
		...
		////prj.m_sensorModel->optimizeFit(*prj.m_CtrlGptSet, exteriorList);
		////prj.m_sensorModel->updateModel();
		Hj1Optimize::exteriorOptimize::adjustment(hj1OptStructList, exteriorList);
		...
		for (size_t i = 0; i < nl; i++)
		{
			...
			hj1OptStructList[i].hj1Model->theSupportData->getAttitude(t_line, att0);
			att.x = att0.x + hj1OptStructList[i].hj1Model->thePitchOffset*1e-3;
			att.y = att0.y + hj1OptStructList[i].hj1Model->theRollOffset*1e-3;
			att.z = att0.z + hj1OptStructList[i].hj1Model->theYawOffset*1e-3;
...
void calcAttitudeSparse()
{
	...
	Hj1Optimize::blockadjustment::Hj1Calibration *hj1Calibration = new Hj1Optimize::blockadjustment::Hj1Calibration();
	hj1Calibration->adjustment(hj1OptStructList, innerList, exteriorList);

	delete hj1Calibration;
	...
	for (size_t i = 0; i < nl; i++)
	{
		...
		ossimDpt3d att(0.0, 0.0, 0.0);
		hj1OptStructList[i].hj1Model->theSupportData->getAttitude(t_line, att);
		att.x += hj1OptStructList[i].hj1Model->thePitchOffset*1e-4;
		att.y += hj1OptStructList[i].hj1Model->theRollOffset*1e-4;
		att.z += hj1OptStructList[i].hj1Model->theYawOffset*1e-4;
