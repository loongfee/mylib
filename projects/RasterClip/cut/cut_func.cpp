...
bool cut_by_shp(const char* inputImageFile, const char* shpfileName, const char* fieldName, const char* searchValue,
	const char* strPrjFile, const char* strOutFile, const char* strOutBandList/* = ""*/, int offset/* = 0*/)
{
	OGRDataSource       *poDS;
	...
	cut_by_rect(inputImageFile, boundaryList, strPrjFile, tmp_file, strOutBandList, offset);
	...
	const char* strPrjFile, const char* strOutFile, const char* strOutBandList/* = ""*/, int offset/* = 0*/)
{
	...
	return cut_by_rect(inputImageFile, boundaryList, strPrjFile, strOutFile, strOutBandList, offset);
}

///////////////////////////////////////////
// 根据矩形区域进行裁剪
///////////////////////////////////////////
bool cut_by_rect(const char* inputImageFile, vector<ossimGpt> boundaryList, const char* strPrjFile, const char* strOutFile, const char* strOutBandList/* = ""*/, int offset/* = 0*/)
{
	...
	vector<ossim_uint32> outBandList = getOutputBandList(handler, strOutBandList);
...
// 根据任意边界进行裁剪
///////////////////////////////////////////
bool cut_by_region(const char* inputImageFile, vector<ossimGpt> boundaryList, const char* strPrjFile, const char* strOutFile, const char* strOutBandList/* = ""*/, int offset/* = 0*/)
{
	ossimImageHandler* handler;
	handler = ossimImageHandlerRegistry::instance()->open(ossimFilename(inputImageFile));
	if (!handler)
